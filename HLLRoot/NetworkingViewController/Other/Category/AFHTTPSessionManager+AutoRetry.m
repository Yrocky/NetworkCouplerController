...
- (NSURLSessionDataTask *)GET:(NSString *)URLString
    ...
    return [self GET:URLString parameters:parameters progress:uploadProgress success:success failure:failure autoRetry:timesToRetry retryInterval:0];
}
                ...
                retryInterval:(int)intervalInSeconds
{
    NSURLSessionDataTask *task = [self requestUrlWithAutoRetry:timesToRetry retryInterval:intervalInSeconds originalRequestCreator:^NSURLSessionDataTask *(void (^retryBlock)(NSURLSessionDataTask *, NSError *)) {
        ...
        return [self GET:URLString parameters:parameters progress:uploadProgress success:success failure:retryBlock];
